...
namespace Mailer.Mails
{
    public static class Letter
    {
        ...
        private const string css = "body{width:210mm;height:297mm;padding:1.5cm;font-family:tahoma;font-size:12pt}svg{float:right;height:4em}address{font-style:normal;margin-bottom:1cm;border-left:6mm solid gray; padding-left:3mm}";
        public static void Print(string[] sender, string[] recipient, string subject, string[] body)
        {
